...
export const stateRules: Record<string, StateRule[]> = {
  ...
  NC: [
    ...
    rule('STATE_NC_INTERSTITIAL_SPACE_TESTING', 'TESTING', 36,
      ...
      '15A NCAC 02N .0903',
      { equipmentType: 'SECONDARY_CONTAINMENT', notes: 'Applies to double-walled tanks without continuous interstitial monitoring.' }),
  ...
  LA: [
    ...
    rule('STATE_LA_SECONDARY_CONTAINMENT', 'DOCUMENTATION', null,
      ...
      'LAC 33:XI',
      { equipmentType: 'SECONDARY_CONTAINMENT', notes: 'Earlier mandate than the 2015 federal secondary containment requirement.' }),
  ...
  CT: [
    ...
    rule('STATE_CT_NEW_INSTALLATION_DOUBLE_WALL', 'DOCUMENTATION', null,
      ...
      { equipmentType: 'SECONDARY_CONTAINMENT', notes: 'EXCEEDS FEDERAL: Mandatory double-wall + continuous monitoring.' }),
  ],
  ...
  HI: [
    ...
    rule('STATE_HI_SECONDARY_CONTAINMENT_UPGRADE', 'CERTIFICATION', null,
      ...
      'HAR 11-280.1-21',
      { equipmentType: 'LINE_LEAK_DETECTOR', notes: 'CRITICAL DEADLINE: State-mandated upgrade deadline approaching.' }),
    rule('STATE_HI_INTERSTITIAL_MONITORING', 'INSPECTION', null,
      ...
      'HAR 11-280.1',
      { equipmentType: 'TANK', frequencyDays: 30, notes: 'State mandates interstitial monitoring specifically — no alternatives allowed.' }),
  ...
  KY: [
    ...
    rule('STATE_KY_DOUBLE_WALL_MANDATE', 'CERTIFICATION', null,
      ...
      '401 KAR 42:020',
      { equipmentType: 'RELEASE_DETECTION', notes: 'Exceeds federal which allows single-wall with other release detection.' }),
  ...
  MD: [
    ...
    rule('STATE_MD_MONTHLY_INTERSTITIAL_MONITORING', 'INSPECTION', null,
      ...
      'COMAR 26.10',
      { equipmentType: 'TANK', frequencyDays: 30, notes: 'Federal allows multiple methods; Maryland mandates interstitial monitoring specifically.' }),
  ...
  MN: [
    ...
    rule('STATE_MN_SECONDARY_CONTAINMENT_BROAD', 'CERTIFICATION', null,
      ...
      { equipmentType: 'LINE_LEAK_DETECTOR', notes: 'Broader scope than federal — includes dispensers and submersible pumps.' }),
  ...
  NE: [
    ...
    rule('STATE_NE_SECONDARY_CONTAINMENT_2007', 'CERTIFICATION', null,
      ...
      'Title 159, Ch. 4',
      { equipmentType: 'TANK', notes: 'Pre-dates the 2015 federal secondary containment requirement by 8 years.' }),
  ...
  OK: [
    ...
    rule('STATE_OK_DOUBLE_WALL_2008', 'CERTIFICATION', null,
      ...
      'OAC 165:25',
      { equipmentType: 'LINE_LEAK_DETECTOR', notes: 'Pre-dates 2015 federal secondary containment requirement.' }),
  ...
  OR: [
    ...
    rule('STATE_OR_SECONDARY_CONTAINMENT', 'DOCUMENTATION', null,
      ...
      'OAR 340-150-0135',
      { equipmentType: 'TANK', notes: 'Applies to all new/replacement installations.' }),
  ...
  WV: [
    ...
    rule('STATE_WV_ADVANCE_NOTIFICATION', 'DOCUMENTATION', null,
      ...
      '33CSR30-4',
      { equipmentType: 'TANK', notes: '30-day advance notice for specific work types.' }),
  ...
  WY: [
    ...
    rule('STATE_WY_SECONDARY_CONTAINMENT', 'DOCUMENTATION', null,
      ...
      { equipmentType: 'TANK', notes: 'Early adopter — secondary containment required since 2005.' }),
